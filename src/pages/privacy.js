...
const Privacy = () => {
  return (
    <>
      <Head>
        <title>Privacy Policy - 21 CTL</title>
      ...
      <div className="mt-32 pb-20 max-w-3xl m-auto">
        <p className="mb-8">
          Welcome to 21st Century Technologies. We understand that privacy
          ...
          and make use of the various services offered by 21st Century
          Technologies (collectively, “Services”) (“Authorized Customers”).
        </p>
        <div className="mt-5">
          <h3 className="font-bold">“Personally Identifiable Information”</h3>
          <p className="mt-3">
        ...
        <div className="mt-5">
          ...
          <p className="mt-3">
            ...
            business, and the nature and size of the advertising inventory that
            the Authorized Customer intends to purchase or sell.
          </p>
        </div>
        <div className="mt-5">
          <h3 className="font-bold">
          ...
          <p className="mt-3">
            ...
            retain, or use the information given to them.
          </p>
        </div>
        <div className="mt-5">
          <h3 className="font-bold">
        ...
        <div className="mt-5">
          ...
          <p className="mt-3">
            ...
            potential transactions with other Authorized Customers. We may share
            aggregated information about our Visitors, including the
            ...
            opportunity to “opt out” of receiving information or being contacted
            by us or by any agency acting on our behalf.
          </p>
        </div>
        <div className="mt-5">
          <h3 className="font-bold">
          ...
          <p className="mt-3">
            Personally Identifiable Information collected by 21st Century
            Technologies is securely stored and is not accessible to third
            parties or employees of 21st Century Technologies except for use as
            indicated above.
          </p>
        </div>
        <div className="mt-5">
        ...
        <div className="mt-5">
          <h3 className="font-bold">Are Cookies Used on the Site?</h3>
          <p className="mt-3">
            ...
            automatically log the Authorized Customer off. Visitors who do not
            wish to have cookies placed on their computers should set their
            browsers to refuse cookies before using https://www.21ctl.com, with
            the drawback that certain features of the website may not function
            properly without the aid of cookies.
          </p>
        </div>
        <div className="mt-5">
          <h3 className="font-bold">
            How does 21st Century Technologies use login information?
          </h3>
          <p className="mt-3">
            21st Century Technologies uses login information, including, but not
        ...
        <div className="mt-5">
          ...
          <p className="mt-3">
            21st Century Technologies has entered into and will continue to
            enter into partnerships and other affiliations with a number of
            vendors. Such vendors may have access to certain Personally
            Identifiable Information on a need to know the basis for evaluating
            Authorized Customers for service eligibility. Our privacy policy
            does not cover their collection or use of this information.
            Disclosure of Personally Identifiable Information to comply with the
            law. We will disclose Personally Identifiable Information in order
            to comply with a court order or subpoena or a request from a law
        ...
        <div className="mt-5">
          ...
          <p className="mt-3">
            ...
            place to protect information sent over the Internet. While we take
        ...
        <div className="mt-5">
          ...
          <p className="mt-3">
            ...
            inaccuracies by emailing us at inquiry@21ctl.com
          </p>
        </div>
        <div className="mt-5">
          <h3 className="font-bold">
          ...
          <p className="mt-3">
            ...
            Site’s database by contacting. However, because of backups and
            records of deletions, it may be impossible to delete a Visitor’s
            entry without retaining some residual information. An individual who
            ...
            sell, transfer, or use Personally Identifiable Information relating
            to that individual in any way moving forward.
          </p>
        </div>
        <div className="mt-5">
          ...
          <p className="mt-3">
            <strong>
              These are summarized rights that you have under data protection
              law
            </strong>
        ...
        <div className="mt-5">
          ...
          <p className="mt-3">
            We will let our Visitors and Authorized Customers know about changes
            to our privacy policy by posting such changes on the Site. However,
            if we are changing our privacy policy in a manner that might cause
            disclosure of Personally Identifiable Information that a Visitor or
            Authorized Customer has previously requested not be disclosed, we
            will contact such Visitor or Authorized Customer to allow such
        ...
        <div className="mt-5">
          ...
          <p className="mt-3">
            <a href="https://www.21ctl.com">https://www.21ctl.com</a> contains
            links to other websites. Please note that when you click on one of
            these links, you are moving to another website. We encourage you to
            read the privacy statements of these linked sites as their privacy
