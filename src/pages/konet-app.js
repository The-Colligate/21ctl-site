            ...
            <div className="flex justify-between items-center tablet:flex-col">
              <div className="ml-20 tablet:ml-0">
                <div className="flex justify-center items-center tablet:flex-col">
                  <div className="flex flex-col mb-10 justify-center items-center border border-[#808080] border-opacity-[23%] rounded-3xl w-[300px] p-10 ">
                  ...
                  <div className="flex flex-col justify-center mb-10 items-center mx-10 border border-[#808080] border-opacity-[23%] py-10 px-5 rounded-3xl w-[300px] tablet:my-10">
                ...
                <div className="flex justify-center items-center tablet:flex-col">
                  ...
                  <div className="flex flex-col justify-center mx-10  items-center border border-[#808080] border-opacity-[23%] p-10 rounded-3xl w-[300px] tablet:ml-10 tablet:my-10">
              ...
              <div>
                <img src="https://res.cloudinary.com/dypedkp7i/image/upload/v1678826866/21ctl/Group_56142_ebvvgh.png" />
              </div>
            </div>
          </section>
            ...
            <div className="konet_wallet_green_bg flex justify-end items-center">
              ...
              <div className="w-[650px] pr-10 flex flex-col justify-center items-start tablet:w-full tablet:ml-0 tablet:pr-0">
                ...
                <p className=" text-[50px] font-bold text-white leading-10 tablet:text-[30px]">
                  Make every call more <br className="tablet:hidden" />
                  productive
                </p>
          ...
          <section className="flex justify-between items-center my-10 tablet:flex-col tablet:mx-10">
            <div className="w-[650px] ml-20 tablet:w-full tablet:ml-10 ">
              <p className=" text-[50px] font-bold text-[#606163] dark:text-white leading-[60px] tablet:text-[38px]">
                A better way to
                <br />
                <span className="text-[#3572AD]">communicate</span>, no <br />
                matter the <span className="text-[#3572AD]">distance.</span>
              </p>
              <p className=" text-[24px] font-normal text-[#606163] py-10">
                Say goodbye to choppy video calls and hello to crystal-clear
                conversations with our platform.
              </p>
            </div>
            <div>
              <img
                src="https://res.cloudinary.com/dypedkp7i/image/upload/v1678748347/21ctl/Group_56118_wkdysh.png"
                className="mr-20"
              />
            </div>
          </section>
          <section className="flex justify-between items-center my-[209px] mx-20 tablet:flex-col-reverse tablet:mx-10">
            <div>
              <img
                src="https://res.cloudinary.com/dypedkp7i/image/upload/v1678826865/21ctl/Rectangle_11903_yccxxa.png"
                className="mr-20"
              />
            </div>
            <div className="w-[500px] ml-20 tablet:w-full tablet:ml-10 ">
              <p className=" text-[50px] font-bold text-[#606163] dark:text-white leading-[60px] tablet:text-[40px]">
                Bank at your <br />{" "}
                <span className="text-[#3572AD]">fingertips</span>
              </p>
              <p className=" text-[22px] font-normal text-[#606163] py-10">
                Bank safely and securely from the comfort of your own home.
                Access bank URLs directly from our app and manage your finances
                on the go.
              </p>
            </div>
          </section>
