        ...
        <div className="w-full min-h-screen flex flex-col z-[0] ">
          ...
          <section className="konet__landing__page pt-[10vh] flex justify-between items-center tablet:flex-col bg-[#F7F7F8] dark:bg-[#373737] tablet:pt-[20vh] tablet:w-full tablet:px-10">
            <div className="w-[650px] mx-20 tablet:mx-10  tablet:w-full tablet:mb-20">
              <div className="text-[#60A297] text-[18px] font-semibold flex items-center ">
                Seamless Mobile Money{" "}
                <p className="h-[5px] ml-2 w-[37px] rounded-lg bg-[#60A297]"></p>
              </div>
              <p className=" text-[70px]  dark:text-white font-bold text-[#606163] tablet:text-[35px]">
                The <span className="text-[#60A297]">future</span> of <br />
                <span className="text-[#60A297]">finance</span> is in your{" "}
                <br />
                hands
              </p>
              <p className=" text-[24px] font-normal text-[#606163] py-10 tablet:text-[16px]">
                Our wallet platform puts you in control of your finances,
                allowing you to seamlessly manage your money, pay bills, and
                make transactions, all with just a few taps on your device.
              </p>
          ...
          <section className="mt-10  tablet:mx-10">
            <div className="flex flex-col justify-center items-center w-full ">
              <div className="text-[#60A297] text-center text-[18px] flex items-center font-semibold">
              ...
              <p className=" text-[50px] text-center font-semibold text-black  dark:text-white tablet:text-[30px]">
                Experience <span className="text-[#60A297]">Simpler</span> and
                More <span className="text-[#60A297]">Secure</span> Payment
              </p>
          ...
          <section className="flex justify-between items-center my-[209px] tablet:flex-col tablet:mx-10">
            <div className="w-[650px] ml-20 tablet:w-full tablet:ml-10 ">
              ...
              <p className=" text-[50px] font-bold text-black dark:text-white leading-[60px] tablet:text-[40px]">
                <span className="text-[#60A297]">Virtual</span> and <br />
                <span className="text-[#60A297]">Physical</span> Cards <br />
                Made Easy
              </p>
              <p className=" text-[24px] font-normal text-[#606163] py-10">
                Whether you prefer to use virtual or physical cards, our wallet
                has got you covered. It&apos;s the perfect solution for all your
                payment needs.
              </p>
            </div>
            <div>
          ...
          <section className="flex justify-between items-center  mx-20 tablet:flex-col-reverse tablet:mx-10">
            <div>
              <img
                src="/wallet/appMockup.png"
                className="flex justify-center items-center w-[487px]"
              />
            </div>
            ...
            <div className="w-[650px]  tablet:w-full">
              ...
              <p className=" text-[50px] font-bold text-black dark:text-white tablet:text-[36px]">
                One<span className="text-[#60A297]"> Wallet</span> for All{" "}
                <br />
                Your <span className="text-[#60A297]">Bills</span>
              </p>
              <p className=" text-[24px] font-normal text-[#606163] py-10">
                Whether you prefer to use virtual or physical cards, our wallet
                has got you covered. It&apos;s the perfect solution for all your
