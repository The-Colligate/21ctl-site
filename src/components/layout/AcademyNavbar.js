...
import { academyNavLinks, trainingCourses } from '../constants/NavbarLinks';
                    ...
                    {(
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {aboutUsLink.name} {displayPopup[0] && displayPopup[1] === -2 ? <CaretDown className="ml-1 -rotate-180" /> : <CaretDown className="ml-1" />}
                                </a>
                            </div>
                        </Popover>
                    )}
                    {(
                                                ...
                                                >
                                                    <div key={name.name}>
                                                        ...
                                                        {name.courses.map((course) =>
                                                            ...
                                                            <div key={course.name} className="flex  opacity-70 hover:text-primary-orange">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    Training {displayPopup[0] && displayPopup[1] === -3 ? <CaretDown className="ml-1 -rotate-180" /> : <CaretDown className="ml-1" />}
                                </a>
                            </div>
                        </Popover>
                    )}

                    {academyNavLinks()[0].navLinks.splice(1).map((link, index) => (
                        <Popover
                            key={link.name}
                            statelessProps={{
                                className: '!p-0 !min-w-[170px] !rounded-lg !bg-transparent',
...
const MobileNavbar = ({ isOpen, theme, setTheme, close, }) => {
    ...
    return (
        <div
            className={` fixed z-50 hidden transition-all duration-300 w-screen h-screen overflow-hidden bg-[#E7DDDA] sh top-0 left-0 translate-x-full ${isOpen ? 'translate-x-0' : ''
                ...
                {showExpanded[1] ? (
                        ...
                        <>
                            ...
                            {showExpanded[0] === -3 ? (
                                <div className='mt-20 px-5'>
                                    ...
                                    <div
                                        className={`  items-start flex-nowrap mr-5 w-full`}
                                    >
                                        {trainingCourses().map((name) => (
                                            <div
                                                key={name.name}
                    ...
                    <ul className="space-y-5 mt-20 text-lg p-5">
                        <li
                            ...
                            onClick={() => setShowExpanded([-2, true])}
                        >
                        ...
                        <li
                            ...
                            onClick={() => setShowExpanded([-3, true])}
                        >
                            <a className="flex items-center justify-between">
